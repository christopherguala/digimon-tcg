...
onAuthStateChanged(auth, async (user) => {
  if (user) {
    ...
    userStore.setUser(user, profile?.username || null, profile?.isAdmin || false);
  } else {
    userStore.logout();
  }
});
...
async function loginUser() {
  try {
    ...
    userStore.setUser(userCredential.user, profile?.username || null, profile?.isAdmin || false);
...
async function registerUser() {
  try {
    ...
    userStore.setUser(userCredential.user, registerUsername.value, false);
    showUser.value = false;
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
      <div class="container-fluid">
        <RouterLink to="/" class="navbar-brand d-flex align-items-center">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQplsVcPVpvqtHUbZVn132oSE9-V98J85n7Jg&s" alt="Logo" class="me-2" />
          Digimon TCG
        </RouterLink>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><RouterLink to="/catalogue" class="nav-link">Catalogue</RouterLink></li>
            <li class="nav-item"><RouterLink to="/vault" class="nav-link">Vault</RouterLink></li>
            <li class="nav-item" v-if="userStore.isAdmin"><RouterLink to="/admin" class="nav-link">Administración</RouterLink></li>
          </ul>
        </div>

        <div class="d-flex align-items-center">
          <div class="position-relative me-2">
            <button class="btn btn-outline-secondary" @click="toggleCart">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTDDGbBPwEeK-Ohb62NGga35q23ndvfl1ycm3Gc0ucHz_VDesD9ojBAOuLyK2KM4pfVS0&usqp=CAU"
    ...
    <div class="offcanvas-body d-flex flex-column">
      ...
      <template v-else>
        <div v-if="!showRegisterForm">
          ...
          <p class="mt-2 text-center">¿No tienes cuenta? 
        ...
        <div v-else>
          ...
          <p class="mt-2 text-center">¿Ya tienes cuenta? 
